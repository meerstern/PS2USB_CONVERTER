...
標準ドライバで動作可能なUSBキーボードをPS2として使用できるように変換します。

プログラミング専用こどもパソコンichigojamやサーバマシンなどのPS2のみサポートしている場合にPS2/USBコンバータを使用して、USBキーボードをPS2化します。
...
## 注意
  ...
  * 上記以外の言語のキーボードでは入力できないキーがある場合があります。
